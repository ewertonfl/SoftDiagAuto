...
public class BluetoothService {
    // Debugging
    private static final String TAG = "ServiçoBluetooth";

    // Name for the SDP record when creating server socket
    private static final String NAME_SECURE = "BluetoothSecureTCC";
    private static final String NAME_INSECURE = "BluetoothInsecureTCC";
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Log.d(TAG, "Conectado!, Socket Type:" + socketType);
                        ...
                        switch (mState) {
                            ...
                            case STATE_CONNECTED:
                                try {
                                    ...
                                    Log.e(TAG, "\n" +
                                            "Não foi possível fechar soquete indesejado", e);
                                }
                                break;
                        }
                    }
