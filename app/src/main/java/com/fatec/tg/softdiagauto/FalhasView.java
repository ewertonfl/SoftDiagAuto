...
public class FalhasView extends AppCompatActivity {
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l1.setAdapter(new FalhasView.dataListAdapter(t1, d1,i1));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.gerar_relatorio_falhas:
                Toast.makeText(this, "Relatório FalhasView", Toast.LENGTH_SHORT).show();
                break;
            case R.id.filtrar_falhas:
                Toast.makeText(this, "Filtro FalhasView", Toast.LENGTH_SHORT).show();
                break;
